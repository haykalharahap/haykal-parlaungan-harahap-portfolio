...
const App: React.FC = () => {
  return (
    <div className="min-h-screen bg-slate-50 selection:bg-indigo-60 selection:text-indigo-900">
      {/* Navbar */}
      <nav className="sticky top-0 z-50 bg-blue/80 backdrop-blur-md border-b border-slate-200">
